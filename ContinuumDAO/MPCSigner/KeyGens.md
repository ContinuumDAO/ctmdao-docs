...
You can see when the record is expanded that it shows the management signature on this node (Ed25519 in this case), that it is of type secp256k1 and multi-agree, with theshold 1 (2 nodes must agree) and you see its public key and its Ethereum address.
